package com.PMS.ProdMmtSys.util;
		...
		public static SessionFactory getSessionFactory()
		{
			if(sessionfactory==null)
			{
				try 
				{
					...
					settings.put(Environment.URL, "jdbc:mysql://localhost:3306/online_product?useSSL=false");
					settings.put(Environment.USER,"root");
					settings.put(Environment.PASS, "Omkar0603@");
